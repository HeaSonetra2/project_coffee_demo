import 'package:coffee_demo/model/product_model.dart';
...
List<ProductModel> product_data = [
  ...
  ProductModel(
    ...
    price: 3.2,
    imageUrl:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgqpEjWZM4UwJMAWrJkeSuyhnrWYfHvMdIKQ&s',
  ),
  ProductModel(
    id: 5,
    name: 'Nymar',
    ...
    price: 3.2,
    imageUrl:
        'https://www.vittoriacoffee.com/cdn/shop/articles/australian-coffee-types_1d9df587-e7d9-405c-ae19-4aa13815cf7a_520x.svg?v=1754012805',
  ),
];
